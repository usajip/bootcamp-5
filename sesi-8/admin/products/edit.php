...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_produk) || empty($kategori) || $harga <= 0) {
        ...
        if (empty($error_message)) {
            $sql = "UPDATE produk SET nama_produk = ?, kategori = ?, harga = ?, gambar = ?, deskripsi = ?, stok = ? WHERE id = ?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssdssii", $nama_produk, $kategori, $harga, $gambar, $deskripsi, $stok, $product_id);
    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-edit me-2"></i>Edit Produk: <?= htmlspecialchars($product['nama_produk']) ?>
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-8">
                                            ...
                                            <select class="form-select" id="kategori" name="kategori" required>
                                                ...
                                                while($category = $categories_result->fetch_assoc()): ?>
                                                    <option value="<?= htmlspecialchars($category['kategori']) ?>"
                                                            <?= ($product['kategori'] === $category['kategori']) ? 'selected' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="deskripsi" 
                                          rows="4" 
                                          placeholder="Deskripsi produk (opsional)"><?= htmlspecialchars($product['deskripsi']) ?></textarea>
                            </div>
                        </div>
